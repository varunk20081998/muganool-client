...
import { Box, Divider, Typography, useTheme, useMediaQuery, InputBase, Button, IconButton } from '@mui/material'
    ...
    return (
        <WidgetWrapper>
            ...
            <FlexBetween gap='1rem'>
                ...
                <InputBase placeholder="whats's on your mind"
            ...
            {isImage &&
                ...
                >
                    <Dropzone
                        ...
                        multiple={false}
                        onDrop={(accepedFiles) => setImage(accepedFiles[0])}
                    >
