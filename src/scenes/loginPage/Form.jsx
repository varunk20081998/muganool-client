...
function Form() {
    ...
    const register = async (values, onSubmitProps) => {
        ...
        const savedUserResponse = await fetch('https://muganool.onrender.com/auth/register', {
            method: 'POST',
            body: formData,
    ...
    const login = async (values, onSubmitProps) => {
        ...
        const logedInUserResponse = await fetch('https://muganool.onrender.com/auth/login ', {
            method: 'POST',
        ...
        const loggedIn = await logedInUserResponse.json();
        onSubmitProps.resetForm();
        if (loggedIn) {
            dispatch(setLogin({
                user: loggedIn.user,
                    ...
                    >
                        {isRegister && (
                            <>
                                ...
                                />
                                <TextField label='Occupation' onBlur={handleBlur}
                                ...
                                >
                                    <Dropzone
                                        ...
                                        multiple={false}
                                        onDrop={(accepedFiles) => setFieldValue('picture', accepedFiles[0])}
                                    >
                        ...
                        <TextField label='Email' onBlur={handleBlur}
                            ...
                            sx={{ gridColumn: 'span 2' }}
                        />
                        <TextField label='Password' onBlur={handleBlur}
